...
import { Field3, Sum as ForeignFieldSum } from './foreign-field.js';
...
declare const Gadgets: {
     ...
     */
    rangeCheck64(x: Field): [import("../field.js").Field, import("../field.js").Field, import("../field.js").Field, import("../field.js").Field];
    /**
     ...
     * ```
     */
    rangeCheckN(n: number, x: Field, message?: string): void;
    /**
     ...
     * ```
     */
    isDefinitelyInRangeN(n: number, x: Field): import("../bool.js").Bool;
     ...
     * ```
     */
    rotate64(field: Field, bits: number, direction?: 'left' | 'right'): import("../field.js").Field;
    /**
     * A (left and right) rotation operates similarly to the shift operation (`<<` for left and `>>` for right) in JavaScript,
     ...
     * ```
     */
    rotate32(field: Field, bits: number, direction?: 'left' | 'right'): import("../field.js").Field;
    /**
     ...
     * ```
     */
    leftShift64(field: Field, bits: number): import("../field.js").Field;
    /**
     * Performs a left shift operation on the provided {@link Field} element.
     * This operation is similar to the `<<` shift operation in JavaScript,
     * where bits are shifted to the left, and the overflowing bits are discarded.
     ...
     * ```
     */
    leftShift32(field: Field, bits: number): import("../field.js").Field;
    /**
     ...
     * ```
     */
    rightShift64(field: Field, bits: number): import("../field.js").Field;
    /**
     ...
     * ```
     */
    rangeCheck3x12(v0: Field, v1: Field, v2: Field): void;
    /**
    ...
    ForeignField: {
         ...
         * ```
         */
        assertMul(x: Field3 | ForeignFieldSum, y: Field3 | ForeignFieldSum, z: Field3 | ForeignFieldSum, f: bigint): void;
        /**
         ...
         * ```
         */
        assertAlmostReduced(xs: Field3[], f: bigint, { skipMrc }?: {
            skipMrc?: boolean | undefined;
        }): void;
        /**
    ...
    Field3: {
        ...
        toBigints<T extends import("../../util/types.js").Tuple<Field3>>(...xs: T): [...{ [i in keyof T]: bigint; }];
        isConstant(x: Field3): boolean;
        provable: {
            toValue(x: Field3): bigint;
            fromValue(x: bigint | Field3): Field3;
            toFields: (x: [import("../field.js").Field, import("../field.js").Field, import("../field.js").Field]) => import("../field.js").Field[];
            toAuxiliary: (x?: [import("../field.js").Field, import("../field.js").Field, import("../field.js").Field] | undefined) => any[];
            sizeInFields: () => number;
            check: (x: [import("../field.js").Field, import("../field.js").Field, import("../field.js").Field]) => void;
            fromFields: (x: import("../field.js").Field[]) => [import("../field.js").Field, import("../field.js").Field, import("../field.js").Field];
            toInput: (x: [import("../field.js").Field, import("../field.js").Field, import("../field.js").Field]) => {
                fields?: import("../field.js").Field[] | undefined;
                packed?: [import("../field.js").Field, number][] | undefined;
            };
            toJSON: (x: [import("../field.js").Field, import("../field.js").Field, import("../field.js").Field]) => [any, any, any];
            fromJSON: (x: [any, any, any]) => [import("../field.js").Field, import("../field.js").Field, import("../field.js").Field];
            empty: () => [import("../field.js").Field, import("../field.js").Field, import("../field.js").Field];
        };
    };
    /**
    ...
    SHA256: {
        ...
        compression: (H: import("../int.js").UInt32[], W: import("../int.js").UInt32[]) => import("../int.js").UInt32[];
        createMessageSchedule: (M: import("../int.js").UInt32[]) => import("../int.js").UInt32[];
        readonly initialState: import("../int.js").UInt32[];
    };
};
