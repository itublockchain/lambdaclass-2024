...
declare class EcdsaSignature {
     ...
     * ```
     */
    verifyV2(message: Bytes, publicKey: FlexiblePoint): import("../bool.js").Bool;
    /**
     ...
     */
    verifySignedHashV2(msgHash: AlmostForeignField | bigint, publicKey: FlexiblePoint): import("../bool.js").Bool;
    /**
