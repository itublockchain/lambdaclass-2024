...
import { Events as BaseEvents, Actions as BaseActions } from '../../bindings/mina-transaction/transaction-leaves.js';
...
declare const HashedAccountUpdate_base: {
    new (hash: import("../provable/field.js").Field, value: import("../provable/types/unconstrained.js").Unconstrained<AccountUpdate>): Hashed<AccountUpdate>;
    create<T>(type: import("../provable/crypto/poseidon.js").ProvableHashable<T>, hash?: ((t: T) => import("../provable/field.js").Field) | undefined): {
        new (hash: import("../provable/field.js").Field, value: import("../provable/types/unconstrained.js").Unconstrained<T>): Hashed<T>;
        create<T>(type: import("../provable/crypto/poseidon.js").ProvableHashable<T>, hash?: ((t: T) => import("../provable/field.js").Field) | undefined): any & {
...
declare const AccountUpdateForest_base: {
    ...
    create<T>(type: import("../provable/crypto/poseidon.js").ProvableHashable<T>, nextHash?: (hash: import("../provable/field.js").Field, value: T) => import("../provable/field.js").Field, emptyHash_?: import("../provable/field.js").Field): {
        new ({ hash, data }: MerkleListBase<T>): MerkleList<T>;
        create<T>(type: import("../provable/crypto/poseidon.js").ProvableHashable<T>, nextHash?: (hash: import("../provable/field.js").Field, value: T) => import("../provable/field.js").Field, emptyHash_?: import("../provable/field.js").Field): any & {
            empty: () => MerkleList<T>;
