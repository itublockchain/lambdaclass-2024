...
import { NonMethods, InferProvable as GenericInferProvable, InferJson, InferredProvable as GenericInferredProvable, IsPure as GenericIsPure, Constructor, InferValue } from '../../../bindings/lib/provable-generic.js';
...
declare function provableFromClass<A, T extends InferProvable<A>>(Class: Constructor<T> & {
    check?: (x: T) => void;
    empty?: () => T;
}, typeObj: A): IsPure<A> extends true ? ProvablePureExtended<T, InferValue<A>, InferJson<A>> : ProvableExtended<T, InferValue<A>, InferJson<A>>;
