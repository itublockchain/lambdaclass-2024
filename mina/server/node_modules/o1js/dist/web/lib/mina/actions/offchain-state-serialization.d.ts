...
declare const ActionList_base: {
    ...
    create<T>(type: ProvableHashable<T>, nextHash?: (hash: import("../../provable/field.js").Field, value: T) => import("../../provable/field.js").Field, emptyHash_?: import("../../provable/field.js").Field): {
        new ({ hash, data }: import("../../provable/merkle-list.js").MerkleListBase<T>): MerkleList<T>;
        create<T>(type: ProvableHashable<T>, nextHash?: (hash: import("../../provable/field.js").Field, value: T) => import("../../provable/field.js").Field, emptyHash_?: import("../../provable/field.js").Field): any & {
            empty: () => MerkleList<T>;
