...
declare namespace method {
    var returns: <K extends string, T extends SmartContract, R extends Provable<any>>(returnType: R) => (target: T & { [k in K]: (...args: any) => Promise<InferProvable<R>>; }, methodName: K & string & keyof T, descriptor: PropertyDescriptor) => void;
}
/**
